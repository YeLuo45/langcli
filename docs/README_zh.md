...
- 更令人兴奋的是Langcli与[LangRouter](https://langrouter.ai/)已深度集成，这样，你可以在一个正在工作的session中根据需求随意使用、切换主流的LLM 模型(包括Claude OPUS 4.6, Deepseek v4 flash, Deepseek v4 pro, GLM 5.1, Kimi K2.6, Minimax M2.5, Mimo 2.5 pro等)，而不会中断你的上下文。
